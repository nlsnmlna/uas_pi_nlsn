...
?>
    ...
    <body>
        ...
        <div class="bg-white dark:bg-gray-900 p-8 m-8 ">
            <h1 class="text-2xl w-full font-semibold bg-white dark:bg-gray-900 text-gray-900 dark:text-white mb-4">Data Rental</h1>
            ...
            <a href="../services/add_rent.php"><button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah Data</button>
            </a>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            $i = 0;
                            $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_rental_nelsen INNER JOIN tbl_pelanggan_nelsen ON tbl_rental_nelsen.nik_ktp_nelsen=tbl_pelanggan_nelsen.nik_ktp_nelsen INNER JOIN tbl_mobil_nelsen ON tbl_rental_nelsen.no_plat_nelsen=tbl_mobil_nelsen.no_plat_nelsen");
                            ...
                            ?>
                                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        <?= $data['lama_nelsen'] ?> Hari
                                    </td>
                                    <td class="px-6 py-4">
                                        Rp. <?= $data['harga_nelsen'] ?>
                                    </td>
                                    <td class="px-6 py-4">
                                        Rp. <?= $data['total_bayar_nelsen'] ?>
                                    </td>
                                    <td class="px-6 py-4">
                                        <a href="../services/edit_rent.php?no_trx_nelsen=<?= $data['no_trx_nelsen'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        ...
                                        <a href="../services/delete_rent.php?no_trx_nelsen=<?= $data['no_trx_nelsen'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">
                                                Delete
                                            </button>
                                        </a>
                                    </td>
