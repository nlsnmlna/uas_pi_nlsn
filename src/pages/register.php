        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div>
                <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                    ...
                    <form method="post" action="../services/register_process.php">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="full_name" id="full_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        </div>
                    ...
                    <div class="text-sm font-medium text-gray-900 dark:text-white">
                        Sudah punya akun ? <a href="login.php" class="text-blue-600 hover:underline dark:text-blue-500"> Login disini</a>
                    </div>
                </div>
            </div>
        </div>
